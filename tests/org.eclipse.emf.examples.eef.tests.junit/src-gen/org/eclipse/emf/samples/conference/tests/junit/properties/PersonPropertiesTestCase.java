...
public class PersonPropertiesTestCase extends SWTBotEEFTestCase {
	...
	public void testEditPersonEclipseCommiter() throws Exception {
		...
		// Change value of the eclipseCommiter feature of the Person element 
				bot.editPropertyTextFeature(propertiesView, ConferenceMessages.PersonPropertiesEditionPart_EclipseCommiterLabel, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
	...
	public void testEditPersonIsRegistered() throws Exception {
		...
		// Change value of the isRegistered feature of the Person element 
				bot.editPropertyTextFeature(propertiesView, ConferenceMessages.PersonPropertiesEditionPart_IsRegisteredLabel, UPDATED_VALUE, bot.selectNode(modelEditor, firstInstanceOf));
