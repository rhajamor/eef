...
public class CheckboxPropertiesEditionProvider implements IPropertiesEditionProvider {
    ...
    return (eObject instanceof Person) && (CheckboxPropertiesEditionComponent.BASE_PART.equals(part));
  }
    ...
    return (eObject instanceof Person) && (refinement == CheckboxPropertiesEditionComponent.class);
  }
    ...
    return (eObject instanceof Person) && ((CheckboxPropertiesEditionComponent.BASE_PART.equals(part) && refinement == CheckboxPropertiesEditionComponent.class));
  }
    ...
    if (eObject instanceof Person) {
      if (CheckboxPropertiesEditionComponent.BASE_PART.equals(part)
        && refinement == CheckboxPropertiesEditionComponent.class)
        return new CheckboxPropertiesEditionComponent(eObject, editing_mode);
    }
    return null;
  }
