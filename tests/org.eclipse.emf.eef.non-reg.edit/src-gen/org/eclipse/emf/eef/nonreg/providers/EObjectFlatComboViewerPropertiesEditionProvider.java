...
public class EObjectFlatComboViewerPropertiesEditionProvider implements IPropertiesEditionProvider {
    ...
    return (eObject instanceof Person) && (EObjectFlatComboViewerPropertiesEditionComponent.BASE_PART.equals(part));
  }
    ...
    return (eObject instanceof Person) && (refinement == EObjectFlatComboViewerPropertiesEditionComponent.class);
  }
    ...
    return (eObject instanceof Person) && ((EObjectFlatComboViewerPropertiesEditionComponent.BASE_PART.equals(part) && refinement == EObjectFlatComboViewerPropertiesEditionComponent.class));
  }
    ...
    if (eObject instanceof Person) {
      if (EObjectFlatComboViewerPropertiesEditionComponent.BASE_PART.equals(part)
        && refinement == EObjectFlatComboViewerPropertiesEditionComponent.class)
        return new EObjectFlatComboViewerPropertiesEditionComponent(eObject, editing_mode);
    }
    return null;
  }
