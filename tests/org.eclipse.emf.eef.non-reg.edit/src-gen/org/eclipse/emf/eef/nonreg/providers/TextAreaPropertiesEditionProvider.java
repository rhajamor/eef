...
public class TextAreaPropertiesEditionProvider implements IPropertiesEditionProvider {
    ...
    return (eObject instanceof Person) && (TextAreaPropertiesEditionComponent.BASE_PART.equals(part));
  }
    ...
    return (eObject instanceof Person) && (refinement == TextAreaPropertiesEditionComponent.class);
  }
    ...
    return (eObject instanceof Person) && ((TextAreaPropertiesEditionComponent.BASE_PART.equals(part) && refinement == TextAreaPropertiesEditionComponent.class));
  }
    ...
    if (eObject instanceof Person) {
      if (TextAreaPropertiesEditionComponent.BASE_PART.equals(part)
        && refinement == TextAreaPropertiesEditionComponent.class)
        return new TextAreaPropertiesEditionComponent(eObject, editing_mode);
    }
    return null;
  }
