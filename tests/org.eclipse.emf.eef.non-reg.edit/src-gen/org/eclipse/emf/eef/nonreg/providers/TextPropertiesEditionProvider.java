...
public class TextPropertiesEditionProvider implements IPropertiesEditionProvider {
    ...
    return (eObject instanceof Adress) && (TextPropertiesEditionComponent.BASE_PART.equals(part));
  }
    ...
    return (eObject instanceof Adress) && (refinement == TextPropertiesEditionComponent.class);
  }
    ...
    return (eObject instanceof Adress) && ((TextPropertiesEditionComponent.BASE_PART.equals(part) && refinement == TextPropertiesEditionComponent.class));
  }
    ...
    if (eObject instanceof Adress) {
      if (TextPropertiesEditionComponent.BASE_PART.equals(part)
        && refinement == TextPropertiesEditionComponent.class)
        return new TextPropertiesEditionComponent(eObject, editing_mode);
    }
    return null;
  }
