    ...
    // Start of user code addToAdvancedtablecomposition() method body
        ...
        if (editionPolicy != null) {
          ...
          if (propertiesEditionObject != null) {
            ...
            advancedtablecomposition.refresh();
            propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdvancedTableCompositionPropertiesEditionPartImpl.this, NonregViewsRepository.AdvancedTableComposition.advancedtablecomposition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
          }
        }
    ...
    // Start of user code addToAdvancedtablecompositionRO() method body
        ...
        if (editionPolicy != null) {
          ...
          if (propertiesEditionObject != null) {
            ...
            advancedtablecompositionRO.refresh();
            propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdvancedTableCompositionPropertiesEditionPartImpl.this, NonregViewsRepository.AdvancedTableComposition.advancedtablecompositionRO, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
          }
        }
