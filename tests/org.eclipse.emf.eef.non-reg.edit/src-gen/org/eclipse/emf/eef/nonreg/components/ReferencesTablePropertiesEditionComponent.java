...
public class ReferencesTablePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (basePart != null && key == NonregViewsRepository.ReferencesTable.class) {
			...
			basePart.addFilterToReferencestable(new EObjectStrictFilter(NonregPackage.eINSTANCE.getTalk()));
			...
			basePart.addFilterToReferencestableRO(new EObjectStrictFilter(NonregPackage.eINSTANCE.getTalk()));
