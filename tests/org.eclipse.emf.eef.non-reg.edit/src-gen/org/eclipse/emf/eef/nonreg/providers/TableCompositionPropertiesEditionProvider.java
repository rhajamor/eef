...
public class TableCompositionPropertiesEditionProvider implements IPropertiesEditionProvider {
    ...
    return (eObject instanceof EclipseSummit) && (TableCompositionPropertiesEditionComponent.BASE_PART.equals(part));
  }
    ...
    return (eObject instanceof EclipseSummit) && (refinement == TableCompositionPropertiesEditionComponent.class);
  }
    ...
    return (eObject instanceof EclipseSummit) && ((TableCompositionPropertiesEditionComponent.BASE_PART.equals(part) && refinement == TableCompositionPropertiesEditionComponent.class));
  }
    ...
    if (eObject instanceof EclipseSummit) {
      if (TableCompositionPropertiesEditionComponent.BASE_PART.equals(part)
        && refinement == TableCompositionPropertiesEditionComponent.class)
        return new TableCompositionPropertiesEditionComponent(eObject, editing_mode);
    }
    return null;
  }
