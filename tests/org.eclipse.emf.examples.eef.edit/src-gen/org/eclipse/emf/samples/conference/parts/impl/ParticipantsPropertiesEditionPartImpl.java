 ...
 * 
 */
public class ParticipantsPropertiesEditionPartImpl extends CompositePropertiesEditingPart implements SWTPropertiesEditingPart, ParticipantsPropertiesEditionPart {
...
protected List<ViewerFilter> participantsFilters = new ArrayList<ViewerFilter>();
	 ...
	 * 
	 */
	public ParticipantsPropertiesEditionPartImpl(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createParticipantsAdvancedTableComposition(Composite parent) {
		this.participants = new ReferencesTable(ConferenceMessages.ParticipantsPropertiesEditionPart_ParticipantsLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(ParticipantsPropertiesEditionPartImpl.this, ConferenceViewsRepository.Participants.participants_, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.ADD, null, null));
				participants.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(ParticipantsPropertiesEditionPartImpl.this, ConferenceViewsRepository.Participants.participants_, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.EDIT, null, element));
				participants.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(ParticipantsPropertiesEditionPartImpl.this, ConferenceViewsRepository.Participants.participants_, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.MOVE, element, newIndex));
				participants.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(ParticipantsPropertiesEditionPartImpl.this, ConferenceViewsRepository.Participants.participants_, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.REMOVE, null, element));
				participants.refresh();
			}
		...
		this.participants.setHelpText(propertiesEditingComponent.getHelpContent(ConferenceViewsRepository.Participants.participants_, ConferenceViewsRepository.SWT_KIND));
		this.participants.createControls(parent);
		this.participants.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(ParticipantsPropertiesEditionPartImpl.this, ConferenceViewsRepository.Participants.participants_, PropertiesEditingEventImpl.CHANGE, PropertiesEditingEventImpl.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
