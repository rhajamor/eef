 ...
 * 
 */
public class LocalisationPropertiesEditionPartImpl extends CompositePropertiesEditingPart implements SWTPropertiesEditingPart, LocalisationPropertiesEditionPart {
...
protected List<ViewerFilter> sitesFilters = new ArrayList<ViewerFilter>();
	 ...
	 * 
	 */
	public LocalisationPropertiesEditionPartImpl(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createPlaceText(Composite parent) {
		SWTUtils.createPartLabel(parent, ConferenceMessages.LocalisationPropertiesEditionPart_PlaceLabel, propertiesEditingComponent.isRequired(ConferenceViewsRepository.Localisation.place, ConferenceViewsRepository.SWT_KIND));
		...
		place.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(LocalisationPropertiesEditionPartImpl.this, ConferenceViewsRepository.Localisation.place, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, place.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(ConferenceViewsRepository.Localisation.place, ConferenceViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createSitesAdvancedTableComposition(Composite parent) {
		this.sites = new ReferencesTable(ConferenceMessages.LocalisationPropertiesEditionPart_SitesLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(LocalisationPropertiesEditionPartImpl.this, ConferenceViewsRepository.Localisation.sites, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.ADD, null, null));
				sites.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(LocalisationPropertiesEditionPartImpl.this, ConferenceViewsRepository.Localisation.sites, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.EDIT, null, element));
				sites.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(LocalisationPropertiesEditionPartImpl.this, ConferenceViewsRepository.Localisation.sites, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.MOVE, element, newIndex));
				sites.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(LocalisationPropertiesEditionPartImpl.this, ConferenceViewsRepository.Localisation.sites, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.REMOVE, null, element));
				sites.refresh();
			}
		...
		this.sites.setHelpText(propertiesEditingComponent.getHelpContent(ConferenceViewsRepository.Localisation.sites, ConferenceViewsRepository.SWT_KIND));
		this.sites.createControls(parent);
		this.sites.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(LocalisationPropertiesEditionPartImpl.this, ConferenceViewsRepository.Localisation.sites, PropertiesEditingEventImpl.CHANGE, PropertiesEditingEventImpl.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
