 ...
 * 
 */
public class WidgetPropertiesEditionPartImpl extends CompositePropertiesEditingPart implements SWTPropertiesEditingPart, WidgetPropertiesEditionPart {
	 ...
	 * 
	 */
	public WidgetPropertiesEditionPartImpl(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, ToolkitsMessages.WidgetPropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(ToolkitsViewsRepository.Widget.Properties.name, ToolkitsViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(WidgetPropertiesEditionPartImpl.this, ToolkitsViewsRepository.Widget.Properties.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(ToolkitsViewsRepository.Widget.Properties.name, ToolkitsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
