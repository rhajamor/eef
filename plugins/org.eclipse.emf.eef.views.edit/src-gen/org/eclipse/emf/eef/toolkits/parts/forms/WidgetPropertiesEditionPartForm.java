 ...
 * 
 */
public class WidgetPropertiesEditionPartForm extends CompositePropertiesEditingPart implements FormPropertiesEditingPart, WidgetPropertiesEditionPart {
	 ...
	 * 
	 */
	public WidgetPropertiesEditionPartForm(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ToolkitsMessages.WidgetPropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(ToolkitsViewsRepository.Widget.Properties.name, ToolkitsViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(WidgetPropertiesEditionPartForm.this, ToolkitsViewsRepository.Widget.Properties.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(ToolkitsViewsRepository.Widget.Properties.name, ToolkitsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
