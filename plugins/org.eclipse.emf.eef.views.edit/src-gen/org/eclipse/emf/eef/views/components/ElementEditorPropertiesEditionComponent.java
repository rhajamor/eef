 ...
 * 
 */
public class ElementEditorPropertiesEditionComponent extends ComposedPropertiesEditingComponent {
	...
	public PropertiesEditingPart getPropertiesEditingPart(int kind, String key) {
		if (ElementEditorBasePropertiesEditionComponent.BASE_PART.equals(key)) {
			basePart = (ElementEditorPropertiesEditionPart)elementEditorBasePropertiesEditionComponent.getPropertiesEditingPart(kind, key);
