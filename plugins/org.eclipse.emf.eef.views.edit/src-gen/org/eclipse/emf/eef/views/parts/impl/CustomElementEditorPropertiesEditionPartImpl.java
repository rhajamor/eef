 ...
 * 
 */
public class CustomElementEditorPropertiesEditionPartImpl extends CompositePropertiesEditingPart implements SWTPropertiesEditingPart, CustomElementEditorPropertiesEditionPart {
	 ...
	 * 
	 */
	public CustomElementEditorPropertiesEditionPartImpl(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, ViewsMessages.CustomElementEditorPropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(ViewsViewsRepository.CustomElementEditor.Properties.name, ViewsViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(CustomElementEditorPropertiesEditionPartImpl.this, ViewsViewsRepository.CustomElementEditor.Properties.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(ViewsViewsRepository.CustomElementEditor.Properties.name, ViewsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRepresentationFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ViewsMessages.CustomElementEditorPropertiesEditionPart_RepresentationLabel, propertiesEditingComponent.isRequired(ViewsViewsRepository.CustomElementEditor.Properties.representation, ViewsViewsRepository.SWT_KIND));
		representation = new EObjectFlatComboViewer(parent, !propertiesEditingComponent.isRequired(ViewsViewsRepository.CustomElementEditor.Properties.representation, ViewsViewsRepository.SWT_KIND));
		representation.setLabelProvider(new AdapterFactoryLabelProvider(adapterFactory));

		representation.addSelectionChangedListener(new ISelectionChangedListener() {

			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(CustomElementEditorPropertiesEditionPartImpl.this, ViewsViewsRepository.CustomElementEditor.Properties.representation, PropertiesEditingEventImpl.CHANGE, PropertiesEditingEventImpl.SET, null, getRepresentation()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(ViewsViewsRepository.CustomElementEditor.Properties.representation, ViewsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createReadOnlyCheckbox(Composite parent) {
		...
		readOnly.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(CustomElementEditorPropertiesEditionPartImpl.this, ViewsViewsRepository.CustomElementEditor.Properties.readOnly, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, new Boolean(readOnly.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(ViewsViewsRepository.CustomElementEditor.Properties.readOnly, ViewsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
