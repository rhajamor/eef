 ...
 * 
 */
public class ContainerPropertiesEditionPartImpl extends CompositePropertiesEditingPart implements SWTPropertiesEditingPart, ContainerPropertiesEditionPart {
	 ...
	 * 
	 */
	public ContainerPropertiesEditionPartImpl(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, ViewsMessages.ContainerPropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(ViewsViewsRepository.Container.Properties.name, ViewsViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(ContainerPropertiesEditionPartImpl.this, ViewsViewsRepository.Container.Properties.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(ViewsViewsRepository.Container.Properties.name, ViewsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRepresentationFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ViewsMessages.ContainerPropertiesEditionPart_RepresentationLabel, propertiesEditingComponent.isRequired(ViewsViewsRepository.Container.Properties.representation, ViewsViewsRepository.SWT_KIND));
		representation = new EObjectFlatComboViewer(parent, !propertiesEditingComponent.isRequired(ViewsViewsRepository.Container.Properties.representation, ViewsViewsRepository.SWT_KIND));
		representation.setLabelProvider(new AdapterFactoryLabelProvider(adapterFactory));

		representation.addSelectionChangedListener(new ISelectionChangedListener() {

			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(ContainerPropertiesEditionPartImpl.this, ViewsViewsRepository.Container.Properties.representation, PropertiesEditingEventImpl.CHANGE, PropertiesEditingEventImpl.SET, null, getRepresentation()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(ViewsViewsRepository.Container.Properties.representation, ViewsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
