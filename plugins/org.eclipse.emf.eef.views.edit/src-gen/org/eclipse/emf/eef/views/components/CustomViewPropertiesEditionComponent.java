 ...
 * 
 */
public class CustomViewPropertiesEditionComponent extends ComposedPropertiesEditingComponent {
	...
	public PropertiesEditingPart getPropertiesEditingPart(int kind, String key) {
		if (CustomViewBasePropertiesEditionComponent.BASE_PART.equals(key)) {
			basePart = (CustomViewPropertiesEditionPart)customViewBasePropertiesEditionComponent.getPropertiesEditingPart(kind, key);
