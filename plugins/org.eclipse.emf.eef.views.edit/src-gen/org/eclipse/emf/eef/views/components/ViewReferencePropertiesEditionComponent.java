 ...
 * 
 */
public class ViewReferencePropertiesEditionComponent extends ComposedPropertiesEditingComponent {
	...
	public PropertiesEditingPart getPropertiesEditingPart(int kind, String key) {
		if (ViewReferenceBasePropertiesEditionComponent.BASE_PART.equals(key)) {
			basePart = (ViewReferencePropertiesEditionPart)viewReferenceBasePropertiesEditionComponent.getPropertiesEditingPart(kind, key);
