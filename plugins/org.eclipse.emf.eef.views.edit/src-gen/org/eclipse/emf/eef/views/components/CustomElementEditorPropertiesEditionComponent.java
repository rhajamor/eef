 ...
 * 
 */
public class CustomElementEditorPropertiesEditionComponent extends ComposedPropertiesEditingComponent {
	...
	public PropertiesEditingPart getPropertiesEditingPart(int kind, String key) {
		if (CustomElementEditorBasePropertiesEditionComponent.BASE_PART.equals(key)) {
			basePart = (CustomElementEditorPropertiesEditionPart)customElementEditorBasePropertiesEditionComponent.getPropertiesEditingPart(kind, key);
