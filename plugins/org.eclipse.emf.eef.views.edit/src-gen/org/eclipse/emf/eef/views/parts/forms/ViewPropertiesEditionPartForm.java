 ...
 * 
 */
public class ViewPropertiesEditionPartForm extends CompositePropertiesEditingPart implements FormPropertiesEditingPart, ViewPropertiesEditionPart {
	 ...
	 * 
	 */
	public ViewPropertiesEditionPartForm(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ViewsMessages.ViewPropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(ViewsViewsRepository.View.Properties.name, ViewsViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(ViewPropertiesEditionPartForm.this, ViewsViewsRepository.View.Properties.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(ViewsViewsRepository.View.Properties.name, ViewsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRepresentationFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, ViewsMessages.ViewPropertiesEditionPart_RepresentationLabel, propertiesEditingComponent.isRequired(ViewsViewsRepository.View.Properties.representation, ViewsViewsRepository.FORM_KIND));
		representation = new EObjectFlatComboViewer(parent, !propertiesEditingComponent.isRequired(ViewsViewsRepository.View.Properties.representation, ViewsViewsRepository.FORM_KIND));
		...
		representation.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(ViewPropertiesEditionPartForm.this, ViewsViewsRepository.View.Properties.representation, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, getRepresentation()));
			}

		});
		representation.setID(ViewsViewsRepository.View.Properties.representation);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(ViewsViewsRepository.View.Properties.representation, ViewsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createExplicitCheckbox(FormToolkit widgetFactory, Composite parent) {
		...
		explicit.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(ViewPropertiesEditionPartForm.this, ViewsViewsRepository.View.Properties.explicit, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, new Boolean(explicit.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(ViewsViewsRepository.View.Properties.explicit, ViewsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
