 ...
 * 
 */
public class PropertiesEditionContextPropertiesEditionComponent extends ComposedPropertiesEditingComponent {
	...
	public PropertiesEditingPart getPropertiesEditingPart(int kind, String key) {
		if (PropertiesEditionContextBasePropertiesEditionComponent.BASE_PART.equals(key)) {
			basePart = (PropertiesEditionContextPropertiesEditionPart)propertiesEditionContextBasePropertiesEditionComponent.getPropertiesEditingPart(kind, key);
