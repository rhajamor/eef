 ...
 * 
 */
public class FilterPropertiesPropertiesEditionPartForm extends CompositePropertiesEditingPart implements FormPropertiesEditingPart, FilterPropertiesPropertiesEditionPart {
	 ...
	 * 
	 */
	public FilterPropertiesPropertiesEditionPartForm(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, MappingMessages.FilterPropertiesPropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(MappingViewsRepository.FilterProperties.FilterProperties_.name, MappingViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(FilterPropertiesPropertiesEditionPartForm.this, MappingViewsRepository.FilterProperties.FilterProperties_.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(MappingViewsRepository.FilterProperties.FilterProperties_.name, MappingViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createMandatoryCheckbox(FormToolkit widgetFactory, Composite parent) {
		...
		mandatory.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(FilterPropertiesPropertiesEditionPartForm.this, MappingViewsRepository.FilterProperties.FilterProperties_.mandatory, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, new Boolean(mandatory.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(MappingViewsRepository.FilterProperties.FilterProperties_.mandatory, MappingViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
