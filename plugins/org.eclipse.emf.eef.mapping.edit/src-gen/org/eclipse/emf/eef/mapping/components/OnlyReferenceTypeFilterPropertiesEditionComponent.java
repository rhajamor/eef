 ...
 * 
 */
public class OnlyReferenceTypeFilterPropertiesEditionComponent extends ComposedPropertiesEditingComponent {
	...
	public PropertiesEditingPart getPropertiesEditingPart(int kind, String key) {
		if (OnlyReferenceTypeFilterBasePropertiesEditionComponent.BASE_PART.equals(key)) {
			basePart = (OnlyReferenceTypeFilterPropertiesEditionPart)onlyReferenceTypeFilterBasePropertiesEditionComponent.getPropertiesEditingPart(kind, key);
