 ...
 * 
 */
public class JavaExpressionFilterPropertiesEditionPartImpl extends CompositePropertiesEditingPart implements SWTPropertiesEditingPart, JavaExpressionFilterPropertiesEditionPart {
	 ...
	 * 
	 */
	public JavaExpressionFilterPropertiesEditionPartImpl(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createJavaExpressionBodyTextarea(Composite parent) {
		Label javaExpressionBodyLabel = SWTUtils.createPartLabel(parent, MappingMessages.JavaExpressionFilterPropertiesEditionPart_JavaExpressionBodyLabel, propertiesEditingComponent.isRequired(MappingViewsRepository.JavaExpressionFilter.FilterExpression.javaExpressionBody, MappingViewsRepository.SWT_KIND));
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(MappingViewsRepository.JavaExpressionFilter.FilterExpression.javaExpressionBody, MappingViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
