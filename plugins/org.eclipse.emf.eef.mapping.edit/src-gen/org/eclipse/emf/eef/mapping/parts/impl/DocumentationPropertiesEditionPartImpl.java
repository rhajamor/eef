...
public class DocumentationPropertiesEditionPartImpl extends CompositePropertiesEditingPart implements SWTPropertiesEditingPart, DocumentationPropertiesEditionPart {
	...
	protected Composite createDocumentationTextarea(Composite parent) {
		Label documentationLabel = SWTUtils.createPartLabel(parent, MappingMessages.DocumentationPropertiesEditionPart_DocumentationLabel, propertiesEditingComponent.isRequired(MappingViewsRepository.Documentation.Documentation_.documentation__, MappingViewsRepository.SWT_KIND));
		...
		documentation.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(DocumentationPropertiesEditionPartImpl.this, MappingViewsRepository.Documentation.Documentation_.documentation__, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, documentation.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(MappingViewsRepository.Documentation.Documentation_.documentation__, MappingViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
