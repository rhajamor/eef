 ...
 * 
 */
public class OCLFilterPropertiesEditionComponent extends ComposedPropertiesEditingComponent {
	...
	public PropertiesEditingPart getPropertiesEditingPart(int kind, String key) {
		if (OCLFilterBasePropertiesEditionComponent.BASE_PART.equals(key)) {
			basePart = (OCLFilterPropertiesEditionPart)oCLFilterBasePropertiesEditionComponent.getPropertiesEditingPart(kind, key);
