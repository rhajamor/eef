 ...
 * 
 */
public class EMFPropertyBindingPropertiesEditionComponent extends ComposedPropertiesEditingComponent {
	...
	public PropertiesEditingPart getPropertiesEditingPart(int kind, String key) {
		if (EMFPropertyBindingBasePropertiesEditionComponent.BASE_PART.equals(key)) {
			basePart = (EMFPropertyBindingPropertiesEditionPart)eMFPropertyBindingBasePropertiesEditionComponent.getPropertiesEditingPart(kind, key);
