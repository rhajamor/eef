 ...
 * 
 */
public class StandardPropertyBindingPropertiesEditionComponent extends ComposedPropertiesEditingComponent {
	...
	public PropertiesEditingPart getPropertiesEditingPart(int kind, String key) {
		if (StandardPropertyBindingBasePropertiesEditionComponent.BASE_PART.equals(key)) {
			basePart = (StandardPropertyBindingPropertiesEditionPart)standardPropertyBindingBasePropertiesEditionComponent.getPropertiesEditingPart(kind, key);
