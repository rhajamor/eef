 ...
 * 
 */
public class StandardElementBindingPropertiesEditionComponent extends ComposedPropertiesEditingComponent {
	...
	public PropertiesEditingPart getPropertiesEditingPart(int kind, String key) {
		if (StandardElementBindingBasePropertiesEditionComponent.BASE_PART.equals(key)) {
			basePart = (StandardElementBindingPropertiesEditionPart)standardElementBindingBasePropertiesEditionComponent.getPropertiesEditingPart(kind, key);
