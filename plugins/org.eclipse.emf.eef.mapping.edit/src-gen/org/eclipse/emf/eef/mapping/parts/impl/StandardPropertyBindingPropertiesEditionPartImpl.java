 ...
 * 
 */
public class StandardPropertyBindingPropertiesEditionPartImpl extends CompositePropertiesEditingPart implements SWTPropertiesEditingPart, StandardPropertyBindingPropertiesEditionPart {
	 ...
	 * 
	 */
	public StandardPropertyBindingPropertiesEditionPartImpl(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, MappingMessages.StandardPropertyBindingPropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(MappingViewsRepository.StandardPropertyBinding.Properties.name, MappingViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(StandardPropertyBindingPropertiesEditionPartImpl.this, MappingViewsRepository.StandardPropertyBinding.Properties.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(MappingViewsRepository.StandardPropertyBinding.Properties.name, MappingViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createModelFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, MappingMessages.StandardPropertyBindingPropertiesEditionPart_ModelLabel, propertiesEditingComponent.isRequired(MappingViewsRepository.StandardPropertyBinding.Binding.model, MappingViewsRepository.SWT_KIND));
		model = new EObjectFlatComboViewer(parent, !propertiesEditingComponent.isRequired(MappingViewsRepository.StandardPropertyBinding.Binding.model, MappingViewsRepository.SWT_KIND));
		model.setLabelProvider(new AdapterFactoryLabelProvider(adapterFactory));

		model.addSelectionChangedListener(new ISelectionChangedListener() {

			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(StandardPropertyBindingPropertiesEditionPartImpl.this, MappingViewsRepository.StandardPropertyBinding.Binding.model, PropertiesEditingEventImpl.CHANGE, PropertiesEditingEventImpl.SET, null, getModel()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(MappingViewsRepository.StandardPropertyBinding.Binding.model, MappingViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createViewsAdvancedReferencesTable(Composite parent) {
		...
		this.views.setHelpText(propertiesEditingComponent.getHelpContent(MappingViewsRepository.StandardPropertyBinding.Binding.views, MappingViewsRepository.SWT_KIND));
		this.views.createControls(parent);
		this.views.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(StandardPropertyBindingPropertiesEditionPartImpl.this, MappingViewsRepository.StandardPropertyBinding.Binding.views, PropertiesEditingEventImpl.CHANGE, PropertiesEditingEventImpl.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"views", propertiesEditingComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(StandardPropertyBindingPropertiesEditionPartImpl.this, MappingViewsRepository.StandardPropertyBinding.Binding.views,
	...
	protected void moveViews(EObject element, int oldIndex, int newIndex) {
		propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(StandardPropertyBindingPropertiesEditionPartImpl.this, MappingViewsRepository.StandardPropertyBinding.Binding.views, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.MOVE, element, newIndex));
		views.refresh();
	}
	...
	protected void removeFromViews(EObject element) {
		propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(StandardPropertyBindingPropertiesEditionPartImpl.this, MappingViewsRepository.StandardPropertyBinding.Binding.views, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.REMOVE, null, element));
		views.refresh();
	}
