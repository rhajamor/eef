...
public class DocumentationPropertiesEditionPartForm extends CompositePropertiesEditingPart implements FormPropertiesEditingPart, DocumentationPropertiesEditionPart {
	...
	protected Composite createDocumentationTextarea(FormToolkit widgetFactory, Composite parent) {
		Label documentationLabel = FormUtils.createPartLabel(widgetFactory, parent, MappingMessages.DocumentationPropertiesEditionPart_DocumentationLabel, propertiesEditingComponent.isRequired(MappingViewsRepository.Documentation.Documentation_.documentation__, MappingViewsRepository.FORM_KIND));
		...
		documentation.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(DocumentationPropertiesEditionPartForm.this, MappingViewsRepository.Documentation.Documentation_.documentation__, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, documentation.getText()));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(MappingViewsRepository.Documentation.Documentation_.documentation__, MappingViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
