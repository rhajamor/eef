 ...
 * 
 */
public class ElementBindingReferencePropertiesEditionComponent extends ComposedPropertiesEditingComponent {
	...
	public PropertiesEditingPart getPropertiesEditingPart(int kind, String key) {
		if (ElementBindingReferenceBasePropertiesEditionComponent.BASE_PART.equals(key)) {
			basePart = (ElementBindingReferencePropertiesEditionPart)elementBindingReferenceBasePropertiesEditionComponent.getPropertiesEditingPart(kind, key);
