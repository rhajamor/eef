...
public class EEFStandardFormPage extends AbstractEEFEditorPage {
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		this.viewer = new PropertiesEditingViewer(form.getBody(), null, SWT.NONE, 1);
	...
	protected void refreshFormContents() {
		if (viewer != null && input instanceof EObject) {
			viewer.setInput(new DomainPropertiesEditingContext(null, null, editingDomain, adapterFactory, (EObject) input));
		}
	}
	 ...
	 */
	public PropertiesEditingViewer getPropertiesViewer() {
		return viewer;
	}
