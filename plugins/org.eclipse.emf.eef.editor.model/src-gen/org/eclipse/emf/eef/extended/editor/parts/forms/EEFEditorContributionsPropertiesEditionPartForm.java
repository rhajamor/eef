 ...
 * 
 */
public class EEFEditorContributionsPropertiesEditionPartForm extends CompositePropertiesEditingPart implements FormPropertiesEditingPart, EEFEditorContributionsPropertiesEditionPart {
	 ...
	 * 
	 */
	public EEFEditorContributionsPropertiesEditionPartForm(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EditorMessages.EEFEditorContributionsPropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(EditorViewsRepository.EEFEditorContributions.Naming.name, EditorViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(EEFEditorContributionsPropertiesEditionPartForm.this, EditorViewsRepository.EEFEditorContributions.Naming.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(EditorViewsRepository.EEFEditorContributions.Naming.name, EditorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
