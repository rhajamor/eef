 ...
 * 
 */
public class PartFilterPropertiesEditionPartImpl extends CompositePropertiesEditingPart implements SWTPropertiesEditingPart, PartFilterPropertiesEditionPart {
	 ...
	 * 
	 */
	public PartFilterPropertiesEditionPartImpl(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EditorMessages.PartFilterPropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(EditorViewsRepository.PartFilter.Naming.name, EditorViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(PartFilterPropertiesEditionPartImpl.this, EditorViewsRepository.PartFilter.Naming.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(EditorViewsRepository.PartFilter.Naming.name, EditorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createContextualComponentFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EditorMessages.PartFilterPropertiesEditionPart_ContextualComponentLabel, propertiesEditingComponent.isRequired(EditorViewsRepository.PartFilter.Filter.contextualComponent, EditorViewsRepository.SWT_KIND));
		contextualComponent = new EObjectFlatComboViewer(parent, !propertiesEditingComponent.isRequired(EditorViewsRepository.PartFilter.Filter.contextualComponent, EditorViewsRepository.SWT_KIND));
		...
		contextualComponent.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(PartFilterPropertiesEditionPartImpl.this, EditorViewsRepository.PartFilter.Filter.contextualComponent, PropertiesEditingEventImpl.CHANGE, PropertiesEditingEventImpl.SET, null, getContextualComponent()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(EditorViewsRepository.PartFilter.Filter.contextualComponent, EditorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createFilteredPartFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EditorMessages.PartFilterPropertiesEditionPart_FilteredPartLabel, propertiesEditingComponent.isRequired(EditorViewsRepository.PartFilter.Filter.filteredPart, EditorViewsRepository.SWT_KIND));
		filteredPart = new EObjectFlatComboViewer(parent, !propertiesEditingComponent.isRequired(EditorViewsRepository.PartFilter.Filter.filteredPart, EditorViewsRepository.SWT_KIND));
		...
		filteredPart.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(PartFilterPropertiesEditionPartImpl.this, EditorViewsRepository.PartFilter.Filter.filteredPart, PropertiesEditingEventImpl.CHANGE, PropertiesEditingEventImpl.SET, null, getFilteredPart()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(EditorViewsRepository.PartFilter.Filter.filteredPart, EditorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createMandatoryCheckbox(Composite parent) {
		...
		mandatory.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(PartFilterPropertiesEditionPartImpl.this, EditorViewsRepository.PartFilter.Settings.mandatory, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, new Boolean(mandatory.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(EditorViewsRepository.PartFilter.Settings.mandatory, EditorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
