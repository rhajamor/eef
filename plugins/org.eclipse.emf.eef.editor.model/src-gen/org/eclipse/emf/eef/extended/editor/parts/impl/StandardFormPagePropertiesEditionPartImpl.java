 ...
 * 
 */
public class StandardFormPagePropertiesEditionPartImpl extends CompositePropertiesEditingPart implements SWTPropertiesEditingPart, StandardFormPagePropertiesEditionPart {
	 ...
	 * 
	 */
	public StandardFormPagePropertiesEditionPartImpl(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EditorMessages.StandardFormPagePropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(EditorViewsRepository.StandardFormPage.Naming.name, EditorViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(StandardFormPagePropertiesEditionPartImpl.this, EditorViewsRepository.StandardFormPage.Naming.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(EditorViewsRepository.StandardFormPage.Naming.name, EditorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createTitle_Text(Composite parent) {
		SWTUtils.createPartLabel(parent, EditorMessages.StandardFormPagePropertiesEditionPart_Title_Label, propertiesEditingComponent.isRequired(EditorViewsRepository.StandardFormPage.Naming.title_, EditorViewsRepository.SWT_KIND));
		...
		title_.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(StandardFormPagePropertiesEditionPartImpl.this, EditorViewsRepository.StandardFormPage.Naming.title_, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, title_.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(EditorViewsRepository.StandardFormPage.Naming.title_, EditorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
