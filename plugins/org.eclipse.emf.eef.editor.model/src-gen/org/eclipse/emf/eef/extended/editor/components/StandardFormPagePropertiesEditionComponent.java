 ...
 * 
 */
public class StandardFormPagePropertiesEditionComponent extends ComposedPropertiesEditingComponent {
	...
	public PropertiesEditingPart getPropertiesEditingPart(int kind, String key) {
		if (StandardFormPageBasePropertiesEditionComponent.BASE_PART.equals(key)) {
			basePart = (StandardFormPagePropertiesEditionPart)standardFormPageBasePropertiesEditionComponent.getPropertiesEditingPart(kind, key);
