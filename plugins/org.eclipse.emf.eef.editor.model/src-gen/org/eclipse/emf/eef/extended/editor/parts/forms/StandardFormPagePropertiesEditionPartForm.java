 ...
 * 
 */
public class StandardFormPagePropertiesEditionPartForm extends CompositePropertiesEditingPart implements FormPropertiesEditingPart, StandardFormPagePropertiesEditionPart {
	 ...
	 * 
	 */
	public StandardFormPagePropertiesEditionPartForm(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EditorMessages.StandardFormPagePropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(EditorViewsRepository.StandardFormPage.Naming.name, EditorViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(StandardFormPagePropertiesEditionPartForm.this, EditorViewsRepository.StandardFormPage.Naming.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(EditorViewsRepository.StandardFormPage.Naming.name, EditorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createTitle_Text(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EditorMessages.StandardFormPagePropertiesEditionPart_Title_Label, propertiesEditingComponent.isRequired(EditorViewsRepository.StandardFormPage.Naming.title_, EditorViewsRepository.FORM_KIND));
		...
		title_.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(StandardFormPagePropertiesEditionPartForm.this, EditorViewsRepository.StandardFormPage.Naming.title_, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, title_.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(EditorViewsRepository.StandardFormPage.Naming.title_, EditorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
