 ...
 * 
 */
public class EEFEditorContributionsPropertiesEditionPartImpl extends CompositePropertiesEditingPart implements SWTPropertiesEditingPart, EEFEditorContributionsPropertiesEditionPart {
	 ...
	 * 
	 */
	public EEFEditorContributionsPropertiesEditionPartImpl(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EditorMessages.EEFEditorContributionsPropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(EditorViewsRepository.EEFEditorContributions.Naming.name, EditorViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(EEFEditorContributionsPropertiesEditionPartImpl.this, EditorViewsRepository.EEFEditorContributions.Naming.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(EditorViewsRepository.EEFEditorContributions.Naming.name, EditorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
