 ...
 * 
 */
public class ExplicitPathQueryPropertiesEditionPartImpl extends CompositePropertiesEditingPart implements SWTPropertiesEditingPart, ExplicitPathQueryPropertiesEditionPart {
	 ...
	 * 
	 */
	public ExplicitPathQueryPropertiesEditionPartImpl(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createQueryFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, QueryMessages.ExplicitPathQueryPropertiesEditionPart_QueryLabel, propertiesEditingComponent.isRequired(QueryViewsRepository.ExplicitPathQuery.Properties.query_, QueryViewsRepository.SWT_KIND));
		query = new EObjectFlatComboViewer(parent, !propertiesEditingComponent.isRequired(QueryViewsRepository.ExplicitPathQuery.Properties.query_, QueryViewsRepository.SWT_KIND));
		...
		query.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(ExplicitPathQueryPropertiesEditionPartImpl.this, QueryViewsRepository.ExplicitPathQuery.Properties.query_, PropertiesEditingEventImpl.CHANGE, PropertiesEditingEventImpl.SET, null, getQuery()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditingComponent.getHelpContent(QueryViewsRepository.ExplicitPathQuery.Properties.query_, QueryViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
