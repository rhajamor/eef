 ...
 * 
 */
public class DynamicEEFEditorContributionPropertiesEditionPartForm extends CompositePropertiesEditingPart implements FormPropertiesEditingPart, DynamicEEFEditorContributionPropertiesEditionPart {
	 ...
	 * 
	 */
	public DynamicEEFEditorContributionPropertiesEditionPartForm(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EditorMessages.DynamicEEFEditorContributionPropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(EditorViewsRepository.DynamicEEFEditorContribution.Naming.name, EditorViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(DynamicEEFEditorContributionPropertiesEditionPartForm.this, EditorViewsRepository.DynamicEEFEditorContribution.Naming.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(EditorViewsRepository.DynamicEEFEditorContribution.Naming.name, EditorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createModelFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EditorMessages.DynamicEEFEditorContributionPropertiesEditionPart_ModelLabel, propertiesEditingComponent.isRequired(EditorViewsRepository.DynamicEEFEditorContribution.Binding.model, EditorViewsRepository.FORM_KIND));
		model = new EObjectFlatComboViewer(parent, !propertiesEditingComponent.isRequired(EditorViewsRepository.DynamicEEFEditorContribution.Binding.model, EditorViewsRepository.FORM_KIND));
		...
		model.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(DynamicEEFEditorContributionPropertiesEditionPartForm.this, EditorViewsRepository.DynamicEEFEditorContribution.Binding.model, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, getModel()));
			}

		});
		model.setID(EditorViewsRepository.DynamicEEFEditorContribution.Binding.model);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(EditorViewsRepository.DynamicEEFEditorContribution.Binding.model, EditorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createViewsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.views.setHelpText(propertiesEditingComponent.getHelpContent(EditorViewsRepository.DynamicEEFEditorContribution.Binding.views, EditorViewsRepository.FORM_KIND));
		this.views.createControls(parent, widgetFactory);
		this.views.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(DynamicEEFEditorContributionPropertiesEditionPartForm.this, EditorViewsRepository.DynamicEEFEditorContribution.Binding.views, PropertiesEditingEventImpl.CHANGE, PropertiesEditingEventImpl.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"views", propertiesEditingComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(DynamicEEFEditorContributionPropertiesEditionPartForm.this, EditorViewsRepository.DynamicEEFEditorContribution.Binding.views,
	...
	protected void moveViews(EObject element, int oldIndex, int newIndex) {
		propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(DynamicEEFEditorContributionPropertiesEditionPartForm.this, EditorViewsRepository.DynamicEEFEditorContribution.Binding.views, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.MOVE, element, newIndex));
		views.refresh();
	}
	...
	protected void removeFromViews(EObject element) {
		propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(DynamicEEFEditorContributionPropertiesEditionPartForm.this, EditorViewsRepository.DynamicEEFEditorContribution.Binding.views, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.REMOVE, null, element));
		views.refresh();
	}
