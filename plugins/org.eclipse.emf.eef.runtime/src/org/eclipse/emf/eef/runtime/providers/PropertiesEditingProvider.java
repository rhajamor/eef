...
/**
 * Interface to implement by {@link PropertiesEditingComponent} providers.
 * 
...
public interface PropertiesEditingProvider {
	...
	/**
	 * Returns a {@link PropertiesEditingComponent} able to edit the {@link EObject} in the current
	 * {@link PropertiesEditingContext}.
	 * 
	 * @param editingContext
	 *            the current {@link PropertiesEditingContext}
	 * @param mode
	 *            the editing mode. Available modes are PropertiesEditingComponent.BATCH_MODE or
	 *            PropertiesEditingComponent.LIVE_MODE.
	 * @return a {@link PropertiesEditingComponent} to edit the {@link EObject} in the editingContext
	 */
	public abstract PropertiesEditingComponent getPropertiesEditingComponent(
	 ...
	 *            PropertiesEditingComponent.LIVE_MODE.
	 * @param part
	 *            the key of the part determining the {@link PropertiesEditingComponent} to provide
	 * @return a {@link PropertiesEditingComponent} to edit the {@link EObject} in the editingContext
	 */
	public abstract PropertiesEditingComponent getPropertiesEditingComponent(
	...
	/**
	 * Returns a {@link PropertiesEditingComponent} able to edit the specified eObject for a specific part
