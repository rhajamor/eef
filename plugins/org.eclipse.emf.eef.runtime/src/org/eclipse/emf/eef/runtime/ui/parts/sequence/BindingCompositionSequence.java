...
public class BindingCompositionSequence extends CompositionSequence {
    ...
    public BindingCompositionSequence(PropertiesEditingComponent component) {
        super();
        this.component = component;
    }

    public BindingCompositionSequence(PropertiesEditingComponent component, CompositionStep parent, Object id) {
        super(parent, id);
        this.component = component;
    }
