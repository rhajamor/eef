...
public class EEFRuntimeUIMessages extends NLS {
	...
	public static String PropertiesEditingContentProvider_editingDomain_not_defined;

	public static String PropertiesEditingSection_call;

	public static String PropertiesEditingSection_descriptorToTab_not_found;

	public static String PropertiesEditingSection_error_occured_on;

	public static String PropertiesEditingSection_method_not_found;

	public static String PropertiesEditingViewer_widget_factory_not_defined;

	public static String PropertiesEditingWizard_creation_page_description;

	public static String PropertiesEditingWizard_creation_page_key;

	public static String PropertiesEditingWizard_creation_page_title;

	public static String PropertiesEditingWizard_error_wizard_live_mode;

	public static String PropertiesEditingWizard_main_page_description;

	public static String PropertiesEditingWizard_main_page_key;
	...
	public static String TabbedPropertiesEditingSheetPage_descriptorToTab_not_found;
