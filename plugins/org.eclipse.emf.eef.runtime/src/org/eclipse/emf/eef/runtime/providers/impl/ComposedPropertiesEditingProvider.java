 ...
 */
public class ComposedPropertiesEditingProvider extends PropertiesEditingProviderImpl {
	 ...
	 * Default constructor.
	 */
	public ComposedPropertiesEditingProvider() {
	 ...
	 */
	public ComposedPropertiesEditingProvider(List<PropertiesEditingProvider> editPropertiesProviders) {
	 ...
	 * @param clazz
	 * @param editPropertiesProvider
	 * @deprecated use the PropertiesEditingProvider extension point
	 */
	 ...
	 *      java.lang.String)
	 */
	public PropertiesEditingComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
			String mode) {
		for (PropertiesEditingProvider editPropertiesProvider : editPropertiesProviders) {
			if (editPropertiesProvider.provides(editingContext))
