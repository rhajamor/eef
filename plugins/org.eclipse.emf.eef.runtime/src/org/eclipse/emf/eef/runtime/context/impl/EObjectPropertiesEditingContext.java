...
public class EObjectPropertiesEditingContext implements PropertiesEditingContext {
	 ...
	 */
	public EObjectPropertiesEditingContext(PropertiesEditingContext parentContext, PropertiesEditingComponent propertiesEditingComponent, EObject eObject, AdapterFactory adapterFactory) {
		this.parentContext = parentContext;
		this.propertiesEditingComponent = propertiesEditingComponent;
	...
	/**
	 * @return the propertiesEditingComponent
	 */
	public PropertiesEditingComponent getPropertiesEditingComponent() {
