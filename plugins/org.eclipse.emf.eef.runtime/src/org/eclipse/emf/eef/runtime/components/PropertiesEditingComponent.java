 ...
 *******************************************************************************/
package org.eclipse.emf.eef.runtime.components;
...
public interface PropertiesEditingComponent extends PropertiesEditingListener {
	 ...
	 */
	public abstract PropertiesEditingPart getPropertiesEditingPart(int kind, String key);
	 ...
	 * @param kind
	 *            the kind of the part
	 * @param propertiesEditingPart
	 *            the part to set
	 */
	public void setPropertiesEditingPart(Object key, int kind, PropertiesEditingPart propertiesEditingPart);

	/**
	 * In dynamic case, managed PropertiesEditingPart can ask the component do decide if they compose a
	 * sub-view or not
	 * 
	 * @param key
	...
	/**
	 * This method allow managed PropertiesEditingPart to ask the component if a elementEditor is required or
	 * not
	 * 
	 * @param key
	 *            the key identifying the ElementEditor
	...
	/**
	 * This method allow managed PropertiesEditingPart to ask the component for an ElementEditor help
	 * documentation
	 * 
	 * @param key
	 *            the key identifying the ElementEditor
